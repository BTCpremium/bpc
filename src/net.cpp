...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("BitcoinPremium-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("BitcoinPremium-net");
...
static const char *strDNSSeed[][2] = {
    {"node.bitcoinpremium.org", "node.bitcoinpremium.org"},
	{"chain.bitcoinpremium.org", "chain.bitcoinpremium.org"},
	{"crawl.bitcoinpremium.org", "crawl.bitcoinpremium.org"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("BitcoinPremium-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("BitcoinPremium-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("BitcoinPremium-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("BitcoinPremium-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BitcoinPremium is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("BitcoinPremium-start");
