...
const string strMessageMagic = "BitcoinPremium Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("BitcoinPremium-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BitcoinPremium
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // BitcoinPremium: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BitcoinPremium", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "BPC Genesis";
        CTransaction txNew;
        txNew.nTime = 1482105017;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1482105017;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1979577; // !fTestNet ? 1575379 : 46534;
		

        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x9bebbce494d284786b1eda50fb354d61fc131d98bfc36f71c608b37fa2f9cb0e"));
...
unsigned char pchMessageStart[4] = { 0xbe, 0xfe, 0xbb, 0xe5 };
