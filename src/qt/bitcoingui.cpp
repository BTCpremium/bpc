...
BitcoinGUI::BitcoinGUI(QWidget *parent):
    ...
    optionsDialog(0)
{
    setFixedSize(1140, 572);
    setWindowTitle(tr("Bitcoin Premium") + " - " + tr("Wallet"));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a BitcoinPremium address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About BitcoinPremium"), this);
    aboutAction->setStatusTip(tr("Show information about BitcoinPremium"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitcoinPremium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitcoinPremium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitcoinPremium addresses"));
    secondAuthAction = new QAction(QIcon(":/icons/key"), tr("Second &auth..."), this);
    secondAuthAction->setStatusTip(tr("Second auth with your BitcoinPremium addresses"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Bitcoin Premium client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Bitcoin Premium client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitcoinPremium network", "", count));
}
...
{
    QString strTitle = tr("Bitcoin Premium") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BitcoinPremium address or malformed URI parameters."));
    }
